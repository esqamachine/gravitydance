...
export default function TemplatesAdmin({
  ...
  return (
    <div className="space-y-4">
      ...
      {editing && (
        <div
          className="fixed inset-0 z-[70] flex justify-center overflow-y-auto bg-black/70 backdrop-blur-sm sm:items-start sm:p-4"
          role="dialog"
          aria-modal="true"
          onClick={() => setEditing(false)}
        >
          <div
            className="animate-pop-in min-h-full w-full bg-card p-5 shadow-2xl sm:my-4 sm:min-h-0 sm:max-w-2xl sm:rounded-[1.75rem] sm:border sm:border-white/10 sm:p-6"
