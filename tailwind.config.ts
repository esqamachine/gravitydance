  ...
  theme: {
    extend: {
      colors: {
        ...
        // rgb-триплеты нужны, чтобы работали модификаторы прозрачности (bg-page/80).
        // ВАЖНО: токен называется `page`, а НЕ `base` — иначе `text-base`
        // (встроенный размер шрифта Tailwind) начинает работать ещё и как утилита
        // цвета и перекрывает цвет текста (баг: невидимый текст на светлой теме).
        page: "rgb(var(--base-rgb) / <alpha-value>)", // основной фон
